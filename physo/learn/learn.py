...
def learner ( model,
    ...
    for epoch in range (n_epochs):
        ...
        for i in range (max_time_step):
            ...
            assert is_able_to_sample.all(), "Prior makes it impossible to sample expression as all choosable tokens have 0 prob for %i/%i programs."%(is_able_to_sample.sum(), batch_size)
